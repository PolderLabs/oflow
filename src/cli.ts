...
function helpText(): string {
  return [
    ...
    "  plan issue update --story <iid> --check <ac|position>  tick one acceptance criterion",
    "  plan issue update --story <iid> --uncheck <ac|position>    reopen one criterion",
    ...
    "  --check/--uncheck <ac|position>  plan issue update only: tick or reopen one acceptance",
    "                                  criterion; a tick is a description edit plus an audit note",
