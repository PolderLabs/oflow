...
- [x] Calibration, fourteen negative results, checkpoint comparison, MCP cost
...
Fourteen other capabilities were measured and dropped, including prompt-injection (sixteen in total, counting the two withdrawn paths; the numbered list in [`LAYA-TRIAGE.md`](LAYA-TRIAGE.md) is the source these counts come from)
